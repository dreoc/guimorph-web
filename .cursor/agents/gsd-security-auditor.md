...
**Verification depth scales with `asvs_level`** (see @/Users/austinlutterback/Documents/Personal-Projects/GUImorph/.cursor/gsd-core/references/security-asvs-levels.md for full definitions):
