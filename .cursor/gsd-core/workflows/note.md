...
- **Global scope**: `/Users/austinlutterback/Documents/Personal-Projects/GUImorph/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/austinlutterback/Documents/Personal-Projects/GUImorph/.cursor/notes/`)
...
2. Glob `/Users/austinlutterback/Documents/Personal-Projects/GUImorph/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (/Users/austinlutterback/Documents/Personal-Projects/GUImorph/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/austinlutterback/Documents/Personal-Projects/GUImorph/.cursor/notes/` — works in any directory
