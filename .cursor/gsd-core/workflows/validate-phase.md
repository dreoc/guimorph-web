...
```
Agent(
  prompt="Read /Users/austinlutterback/Documents/Personal-Projects/GUImorph/.cursor/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/austinlutterback/Documents/Personal-Projects/GUImorph/.cursor/gsd-core/templates/VALIDATION.md`
