...
The keys live in `.claude/settings.json` (project) or `/Users/austinlutterback/Documents/Personal-Projects/GUImorph/.cursor/settings.json` (global) — **not** in `.planning/config.json`:
