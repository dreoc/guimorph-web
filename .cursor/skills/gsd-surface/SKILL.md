...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/austinlutterback/Documents/Personal-Projects/GUImorph/.cursor/.gsd-surface.json`
(sibling to `/Users/austinlutterback/Documents/Personal-Projects/GUImorph/.cursor/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/austinlutterback/Documents/Personal-Projects/GUImorph/.cursor/skills/gsd-*/`.
...
(`/Users/austinlutterback/Documents/Personal-Projects/GUImorph/.cursor`), NOT the skills sub-directory (`/Users/austinlutterback/Documents/Personal-Projects/GUImorph/.cursor/skills`).

This matches `installRuntimeArtifacts` and `uninstallRuntimeArtifacts`, which also
receive `/Users/austinlutterback/Documents/Personal-Projects/GUImorph/.cursor` as `configDir`. The skill dirs themselves live at
`/Users/austinlutterback/Documents/Personal-Projects/GUImorph/.cursor/skills/gsd-*/` because the `claude global` layout has `destSubpath =
'skills'` — they are derived from `configDir`, not the root for it.

```bash
# Cursor — global install
RUNTIME_CONFIG_DIR="${CLAUDE_CONFIG_DIR:-/Users/austinlutterback/Documents/Personal-Projects/GUImorph/.cursor}"
SCOPE="global"
...
(i.e. `/Users/austinlutterback/Documents/Personal-Projects/GUImorph/.cursor/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/austinlutterback/Documents/Personal-Projects/GUImorph/.cursor/.gsd-surface.json`
Install profile marker: `/Users/austinlutterback/Documents/Personal-Projects/GUImorph/.cursor/.gsd-profile`
Skill dirs: `/Users/austinlutterback/Documents/Personal-Projects/GUImorph/.cursor/skills/gsd-*/`
Engine module: `/Users/austinlutterback/Documents/Personal-Projects/GUImorph/.cursor/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/austinlutterback/Documents/Personal-Projects/GUImorph/.cursor/gsd-core/bin/lib/clusters.cjs`
</execution_context>
