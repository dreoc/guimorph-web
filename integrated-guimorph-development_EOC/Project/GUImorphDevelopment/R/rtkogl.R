...
# ---------------------------------------------------------------------------
#  Non-engine survivors (dbg, .pkg_version, .module_banner, .isMacOS,
#  normalizeWheelDelta, shortcutLabel, .plot_show, .onAttach) were relocated to
#  R/shell.R in Plan 06-03 so they survive the deletion of this file in Plan 07
#  (RESEARCH Landmine 1). The Tk-only bindPlatformAccelerator/bindDeleteGesture
#  helpers were dropped there (no browser analog). GUImorphWeb() was rewired and
#  moved to R/shell.R as well. Everything remaining in this file is the native
#  tkogl2 engine surface (add/del/set/shows/.gmw_engine/.gmw_require_engine/
#  .onLoad/loadDgt), which Plan 07 deletes wholesale.
# ---------------------------------------------------------------------------
