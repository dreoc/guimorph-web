...
void changeLandmarkDotColor();    // changes the landmarks for the current array slice to the default color
void changeDotColorToSlider(int dotIndex);


// these are for simpleLogging
static FILE* fp = NULL;
...
static int UT_MY_INTEGER_VALUE = 0;  //unit testing in THIS version ONLY 
